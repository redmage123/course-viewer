#!/usr/bin/env python3
"""
Generate PDF from Handling Hallucinations Seminar slides using weasyprint.
...
# Configuration
SLIDES_FILE = Path(__file__).parent / "handling-hallucinations-slides.html"
OUTPUT_PDF = Path(__file__).parent / "handling-hallucinations-slides.pdf"
...
def create_print_html(slides: list[str], original_styles: str) -> str:
    ...
    * {{
    ...
    .danger-box {{
        background: linear-gradient(135deg, #3d1414 0%, #4d1818 100%);
    ...
    /* VERIFY Framework - specific styling */
    .verify-circle {{
        display: flex;
        flex-wrap: wrap;
...
<head>
    <meta charset="UTF-8">
    <title>Handling Hallucinations: Fact-Checking AI - ITAG Skillnet</title>
    <style>
    {print_css}
    </style>
</head>
