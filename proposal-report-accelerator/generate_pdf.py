#!/usr/bin/env python3
"""
Generate PDF from Proposal & Report Accelerator slides using weasyprint.
...
# Configuration
SLIDES_FILE = Path(__file__).parent / "proposal-report-accelerator-slides.html"
OUTPUT_PDF = Path(__file__).parent / "proposal-report-accelerator-slides.pdf"
...
def create_print_html(slides: list[str], original_styles: str) -> str:
    ...
    * {{
    ...
    /* WRITE Framework circle - simplified for print */
    .write-circle {{
        display: flex;
        flex-wrap: wrap;
    ...
    .write-item span:first-child {{
        font-size: 1.8em;
        font-weight: bold;
        color: #4da6ff;
    }}

    .write-item span:last-child {{
        font-size: 1.1em;
        color: #94a3b8;
    }}
...
<head>
    <meta charset="UTF-8">
    <title>Proposal & Report Accelerator - ITAG Skillnet</title>
    <style>
    {print_css}
    </style>
</head>
